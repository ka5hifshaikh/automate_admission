...
//$pdf->AddPage('P','A4');
//$pdf->Image('assets/challan_payment_option_1.jpg',0,0,$pdf->GetPageWidth(),$pdf->GetPageHeight());
//
//$pdf->AddPage('P','A4');
//$pdf->Image('assets/challan_payment_option_2.jpg',0,0,$pdf->GetPageWidth(),$pdf->GetPageHeight());
...
function myFunction($copy, $x,$pdf,$challan)
{
	...
	$pdf->Image('./assets/img/1bill.jpg',25+$x,4,18);
    ...
    //$height=$height+6;
    //$pdf->SetXY($x + 3, $height);
    //$pdf->Cell(32,6,"CMD No.",1,"","C",false);
    
    //$pdf->Cell(33,6,$account_no,1,"","C",false);     
    $height=$height+6;
    $pdf->SetXY($x + 3, $height);
	...
	*/
	...
	$height = $height;
	$pdf->SetFont('Arial','B',8);
    $pdf->text($x+43,$height-14,"DATE: $current_date");
