							...
							<div class="card">
								...
								<div class="card-body">
									...
									<div class='row'>
										<div class='col-md-12'>
											<strong>
												Please select and add your choices in preference order according to your last qualification.<br>
									...
									<div class="row">
										<div class="col-lg-5 col-md-5 ">
											<div class="form-group">
												<label for="exampleInput1" class="bmd-label-floating"> Select Program(s)
