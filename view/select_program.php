                                ...
                                <div class="card-body">
                                    ...
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            ...
                                            Please check Prospectus for pre-requiste for each Degree Program.<br>
                                             <span class='text-danger'><em>Red highlighted degree programs / disciplines / subjects indicates that you do not meet the eligibility criteria based on your given qualification.</em></span>
                                            </strong>
                                            <br>
                                            <strong class= 'bg-danger'>
                                                If you are applying for admission only in Evening Degree Program(s) like MBA (Evening) / B.Ed (Secondary) 1.5 Year Weekend Program OR B.Ed (Secondary) 2.5 Year Weekend Program, you are advised to press the <span class='blink_me text-success'>CLICK HERE TO APPLY FOR EVENING PROGRAMS</span> button. On the next page you will find the list of Evening Degree Programs.
                                            </strong>    
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-lg-5 col-md-5 ">
                                            <div class="form-group">
                                                <label for="exampleInput1" class="bmd-label-floating"> Select and Add Program(s)
                                        ...
                                        <div class="col-md-4">
                                            <br>
                                                <button  class="btn btn-success " id="add_program">Add Choice(s)</button>
                                    ...
                                    <form action="<?=base_url()."form/upload_program_handler"?>"method="post" id = "select_choice_form"  enctype="multipart/form-data">
                                                ...
                                                <table class='table' >
                                                    ...
                                                    foreach ($CHOOSEN_PROGRAM_LIST as $CHOOSEN_PROGRAM ){
                                                       ...
                                                       $PROG_LIST_ID =  $CHOOSEN_PROGRAM['PROG_LIST_ID'];
                                                        ...
                                                        if(LLB_PROG_LIST_ID==$PROG_LIST_ID ||286==$PROG_LIST_ID){
                                                            $show_lat_form = true;
                                                            $min= 1;
                                                        }
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg" onclick="window.location.href = '<?=base_url('form/select_category')?>'">Back</button>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <br>
                                                <span class="input-group-btn">
                                                <?php if($is_evening_category) {
                                                    echo '<button type="button" class="btn btn-success " onclick="get_next()" ><i class="fa fa-next"></i> Click here to add EVENING PROGRAMS </button>';
                                                } else {
                                                    echo '<button type="button" class="btn btn-success " onclick="get_next()" ><i class="fa fa-next"></i> Save & Next </button>';
                                                }
                                                ?>
                                                </span>
                                            </div>
...
<script>
    ...
    function validateProgramSelection(){
        ...
        if(len<=max_list&&min_list<=len) {
            ...
            alertMsg("Warning","You must select minimum "+min_list+" choice...!")
            return false;
        }
    }
    ...
    function addDataInTable(id,txt){
       // minor_option_id_
        ...
        if(len<=max_list) {
            ...
            alertMsg("Warning","You can select maximum "+max_list+" subjects...!")
        }
    ...
    function deleteDataInTable(elementNo,txt){
        ...
        if(elementNo==llb_id || llb_id2 == elementNo){
            min_list = <?=$min?>;
